...
public class LogLevelFilterFileAppender extends FileAppender
{
	...
	private static final String ORIG_LOG_FILE_NAME = "";
	...
	public LogLevelFilterFileAppender(Layout layout, String fileName, boolean append, boolean bufferedIO, int bufferSize) throws IOException
	{
	...
	public void append(LoggingEvent event)
	{
		...
		try
		{
			setFile(appendLevelToFileName((String) MDC.get(ORIG_LOG_FILE_NAME), event.getLevel().toString()), fileAppend, bufferedIO, bufferSize);
		}
